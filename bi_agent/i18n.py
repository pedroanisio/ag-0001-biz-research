...
STRINGS: dict[str, tuple[str, str, str, str, str]] = {
    ...
    "key_messages": ("Key messages", "Mensagens-chave", "Messages clés", "Kernaussagen", "Mensajes clave"),
    "takeaway": ("Takeaway", "Conclusão", "À retenir", "Kernaussage", "Conclusión"),
    "exhibit": ("Exhibit {n}", "Figura {n}", "Figure {n}", "Abbildung {n}", "Figura {n}"),
    "exhibit_sources": ("Sources: {ids}", "Fontes: {ids}", "Sources : {ids}", "Quellen: {ids}", "Fuentes: {ids}"),
    "and_more": ("and {n} more", "e mais {n}", "et {n} autres", "und {n} weitere", "y {n} más"),
    "appendix": ("Appendix: evidence detail", "Anexo: detalhamento das evidências", "Annexe : détail des preuves",
                 "Anhang: Belege im Detail", "Anexo: detalle de la evidencia"),
    "appendix_note": ("Every claim behind the sections above, with its classification and sources.",
                      "Todas as afirmações por trás das seções acima, com sua classificação e fontes.",
                      "Toutes les affirmations qui fondent les sections ci-dessus, avec leur classification et leurs sources.",
                      "Alle Aussagen hinter den obigen Abschnitten, mit Klassifizierung und Quellen.",
                      "Todas las afirmaciones detrás de las secciones anteriores, con su clasificación y fuentes."),
    "swot_grid": ("SWOT at a glance", "SWOT em resumo", "SWOT en un coup d'œil", "SWOT auf einen Blick", "DAFO de un vistazo"),
    "sizing_chart": ("Market size estimates found in the sources", "Estimativas de tamanho de mercado encontradas nas fontes",
                     "Estimations de taille de marché trouvées dans les sources", "In den Quellen gefundene Marktgrößen",
                     "Estimaciones de tamaño de mercado halladas en las fuentes"),
    "maturity_level": ("Level", "Nível", "Niveau", "Stufe", "Nivel"),
    "lvl.nascent": ("Nascent", "Incipiente", "Naissant", "Anfänglich", "Incipiente"),
    "lvl.developing": ("Developing", "Em desenvolvimento", "En développement", "In Entwicklung", "En desarrollo"),
    "lvl.established": ("Established", "Consolidado", "Établi", "Etabliert", "Consolidado"),
    "lvl.leading": ("Leading", "Referência", "Leader", "Führend", "Referente"),
    "lvl.none": ("Not rated", "Sem avaliação", "Non évalué", "Nicht bewertet", "Sin valorar"),
    "maturity_scale": ("Scale (an ordinal judgment against written criteria, not a numeric score): {scale}",
                       "Escala (julgamento ordinal com critérios escritos, não uma nota numérica): {scale}",
                       "Échelle (jugement ordinal selon des critères écrits, pas une note chiffrée) : {scale}",
                       "Skala (ordinale Einschätzung nach schriftlichen Kriterien, keine Punktzahl): {scale}",
                       "Escala (juicio ordinal según criterios escritos, no una puntuación numérica): {scale}"),
    "lvl.nascent.def": ("little or no evidence of the capability; early experiments or claims only",
                        "pouca ou nenhuma evidência da capacidade; apenas experimentos ou alegações iniciais",
                        "peu ou pas de preuve de la capacité ; seulement des essais ou des affirmations",
                        "kaum oder keine Belege für die Fähigkeit; nur erste Versuche oder Behauptungen",
                        "poca o ninguna evidencia de la capacidad; solo pruebas o afirmaciones iniciales"),
    "lvl.developing.def": ("the capability exists and is in use, but is narrow, recent or inconsistent",
                           "a capacidade existe e está em uso, mas é restrita, recente ou irregular",
                           "la capacité existe et est utilisée, mais reste étroite, récente ou irrégulière",
                           "die Fähigkeit besteht und wird genutzt, ist aber eng, neu oder uneinheitlich",
                           "la capacidad existe y se usa, pero es limitada, reciente o irregular"),
    "lvl.established.def": ("proven at scale in its home market, with independent evidence",
                            "comprovada em escala no mercado de origem, com evidência independente",
                            "prouvée à grande échelle sur son marché d'origine, avec des preuves indépendantes",
                            "im Heimatmarkt in großem Maßstab bewiesen, mit unabhängigen Belegen",
                            "probada a escala en su mercado de origen, con evidencia independiente"),
    "lvl.leading.def": ("a reference point for the market, confirmed by independent sources",
                        "referência para o mercado, confirmada por fontes independentes",
                        "une référence pour le marché, confirmée par des sources indépendantes",
                        "ein Maßstab für den Markt, von unabhängigen Quellen bestätigt",
                        "un referente para el mercado, confirmado por fuentes independientes"),
    "positioning": ("Competitive positioning", "Posicionamento competitivo", "Positionnement concurrentiel",
                    "Wettbewerbspositionierung", "Posicionamiento competitivo"),
    "axis_line": ("{axis}: {definition}", "{axis}: {definition}", "{axis} : {definition}", "{axis}: {definition}", "{axis}: {definition}"),
    "pos.1": ("Low", "Baixo", "Faible", "Niedrig", "Bajo"),
    "pos.2": ("Medium", "Médio", "Moyen", "Mittel", "Medio"),
    "pos.3": ("High", "Alto", "Élevé", "Hoch", "Alto"),
    "rationale": ("Rationale", "Justificativa", "Justification", "Begründung", "Justificación"),
